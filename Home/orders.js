...
const SACRAMENTO_RESERVE_TRIGGER_SELECTOR = [
  ...
  "#wellnessBookBtn",
  "#wellnessExperienceSummary a.total-btn",
  "#wellnessBookWithOrder",
  "#bookNowBottomCandombe",
  "#orderSummaryCandombe a.total-btn",
  "#bookWithOrderCandombe",
  "#bookNowBottomPrivateWalking",
  "#orderSummaryPrivateWalking a.total-btn",
  "#bookWithOrderPrivateWalking",
  "#cabalFooterReserve",
