...
const translations = {
    en: {
      ...
      vinos_price_title: "From USD 20 per guest",
      vinos_hours: "Mon–Fri · 11 AM – 7 PM",
      vinos_price_p:
        "Three tasting options at Vinos del Mundo (USD 20, USD 25, or USD 30). Uruguayan wines. Options 1 and 2 include three empanadas. Add one order per guest — the summary and total update automatically.",
    ...
    es: {
      ...
      vinos_price_title: "Desde USD 20 por huésped",
      vinos_hours: "Lun–Vie · 11 AM – 7 PM",
      vinos_price_p:
        "Tres opciones de degustación en Vinos del Mundo (USD 20, USD 25 o USD 30). Vinos uruguayos. Las opciones 1 y 2 incluyen tres empanadas. Agregá un pedido por huésped — el resumen y el total se actualizan solos.",
    ...
    pt: {
      ...
      vinos_price_title: "A partir de USD 20 por hóspede",
      vinos_hours: "Seg–Sex · 11h – 19h",
      vinos_price_p:
        "Três opções de degustação no Vinos del Mundo (USD 20, USD 25 ou USD 30). Vinhos uruguaios. As opções 1 e 2 incluem três empanadas. Adicione um pedido por hóspede — o resumo e o total são atualizados automaticamente.",
