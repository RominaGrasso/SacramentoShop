...
const translations = {
    en: {
      ...
      home_royal_meta_3: "Swimming pool",
      home_royal_meta_4: "Single USD 65 · Double USD 70 · Triple USD 85",
      home_royal_desc:
        "Hotel on a main avenue in Colonia, 200 meters from the UNESCO Historic Quarter and the beach. Eight blocks from the river and land terminals. Breakfast included, pool, and single, double, and triple rooms.",
      ...
      royal_about_p:
        "Hotel Royal is located on one of Colonia del Sacramento's main avenues, just 200 meters from the UNESCO Historic Quarter (World Heritage Site since 1995). The beach is also 200 meters away, and the river and land terminals are eight blocks from the hotel. Enjoy breakfast included, a swimming pool, and comfortable single, double, and triple rooms — an ideal base to explore Colonia.",
      royal_steps_title: "How to book",
      royal_step_1_title: "Choose your dates:",
      royal_step_1_desc: "Select your check-in date and room type below.",
      royal_step_2_title: "Room options:",
      royal_step_2_desc: "Single, double, or triple rooms — tell us how many rooms you need.",
      royal_step_3_title: "Confirm on WhatsApp:",
      royal_step_3_desc: "We check availability and confirm your booking details.",
      royal_price_line: "Single USD 65 · Double USD 70 · Triple USD 85",
      royal_price_title: "Per night · Breakfast included",
      royal_price_p:
        "Rates per room per night. Use “Check availability” to confirm dates and room type on WhatsApp before booking.",
      royal_rate_per_night: "Rate per night",
      royal_estimated_total: "Estimated total",
      royal_included_title: "What's included",
      royal_include_1: "✔ Breakfast included",
      royal_include_2: "✔ Swimming pool",
      ...
      royal_rooms_title: "Room types & rates",
      royal_room_single: "🛏 Single room · USD 65 per night",
      royal_room_double: "🛏 Double room · USD 70 per night",
      royal_room_triple: "🛏 Triple room · USD 85 per night",
      royal_room_single_short: "Single · USD 65",
      royal_room_double_short: "Double · USD 70",
      royal_room_triple_short: "Triple · USD 85",
      ...
      royal_create_title: "Request your stay",
      royal_checkin_label: "Check-in date",
      royal_checkin_hint: "Pick your preferred check-in date so we can check room availability.",
      royal_room_type_label: "Room type",
      royal_rooms_count_label: "Number of rooms",
      royal_nights_label: "Nights",
      royal_reserve_btn: "Check availability",
      royal_wa_intro:
        "Hello! I'd like to check availability at Hotel Royal for the following stay:",
      royal_wa_footer:
        "Could you please confirm if there is availability for these dates and send me the rate? Thank you!",
      ...
      bruma_price_title: "Standard USD 45 → USD 35 per guest · Premium USD 60 → USD 50",
      bruma_price_standard_label: "Standard",
      bruma_price_standard_original: "USD 45",
      bruma_price_standard_discount: "USD 35 per guest",
      bruma_price_premium_label: "Premium",
      bruma_price_premium_original: "USD 60",
      ...
      bruma_tier_standard_option: "Standard — USD 35 per guest (was USD 45)",
      bruma_tier_premium_option: "Premium — USD 50 per guest (was USD 60)",
      ...
      bruma_whatsapp_premium: "Premium (USD 50 launch · was USD 60)",
      bruma_whatsapp_standard: "Standard (USD 35 launch · was USD 45)",
      bruma_order_tier_label: "Menu",
      bruma_order_tier_premium: "Premium · USD 50 (launch price)",
      bruma_order_tier_standard: "Standard · USD 35 (launch price)",
    ...
    es: {
      ...
      home_royal_meta_3: "Piscina",
      home_royal_meta_4: "Single USD 65 · Doble USD 70 · Triple USD 85",
      home_royal_desc:
        "Hotel en una de las principales avenidas de Colonia, a 200 metros del Barrio Histórico UNESCO y de la playa. A 8 cuadras de las terminales fluvial y terrestre. Desayuno incluido, piscina y habitaciones single, doble y triple.",
      ...
      royal_about_p:
        "El Hotel Royal está ubicado en una de las principales avenidas de Colonia del Sacramento, a solo 200 metros del Barrio Histórico, declarado Patrimonio de la Humanidad en 1995. A 200 metros de la playa y a 8 cuadras de las terminales fluvial y terrestre. Desayuno incluido, piscina y habitaciones single, doble y triple — una base ideal para explorar Colonia.",
      royal_steps_title: "Cómo reservar",
      royal_step_1_title: "Elegí tus fechas:",
      royal_step_1_desc: "Seleccioná la fecha de check-in y el tipo de habitación abajo.",
      royal_step_2_title: "Opciones de habitación:",
      royal_step_2_desc: "Single, doble o triple — indicanos cuántas habitaciones necesitás.",
      royal_step_3_title: "Confirmá por WhatsApp:",
      royal_step_3_desc: "Verificamos disponibilidad y confirmamos los detalles de tu reserva.",
      royal_price_line: "Single USD 65 · Doble USD 70 · Triple USD 85",
      royal_price_title: "Por noche · Desayuno incluido",
      royal_price_p:
        "Tarifas por habitación por noche. Usá “Verificar disponibilidad” en WhatsApp para confirmar fechas y tipo de habitación antes de reservar.",
      royal_rate_per_night: "Tarifa por noche",
      royal_estimated_total: "Total estimado",
      royal_included_title: "Qué incluye",
      royal_include_1: "✔ Desayuno incluido",
      royal_include_2: "✔ Piscina",
      ...
      royal_rooms_title: "Tipos de habitación y tarifas",
      royal_room_single: "🛏 Habitación single · USD 65 por noche",
      royal_room_double: "🛏 Habitación doble · USD 70 por noche",
      royal_room_triple: "🛏 Habitación triple · USD 85 por noche",
      royal_room_single_short: "Single · USD 65",
      royal_room_double_short: "Doble · USD 70",
      royal_room_triple_short: "Triple · USD 85",
      ...
      royal_create_title: "Solicitá tu estadía",
      royal_checkin_label: "Fecha de check-in",
      royal_checkin_hint: "Elegí la fecha de ingreso para que podamos verificar disponibilidad.",
      royal_room_type_label: "Tipo de habitación",
      royal_rooms_count_label: "Cantidad de habitaciones",
      royal_nights_label: "Noches",
      royal_reserve_btn: "Verificar disponibilidad",
      royal_wa_intro:
        "¡Hola! Quisiera consultar disponibilidad en el Hotel Royal para:",
      royal_wa_footer:
        "¿Podrían confirmar si hay disponibilidad para esas fechas y enviarme la tarifa? ¡Gracias!",
      ...
      bruma_price_title: "Estándar USD 45 → USD 35 por huésped · Premium USD 60 → USD 50",
      bruma_price_standard_label: "Estándar",
      bruma_price_standard_original: "USD 45",
      bruma_price_standard_discount: "USD 35 por huésped",
      bruma_price_premium_label: "Premium",
      bruma_price_premium_original: "USD 60",
      ...
      bruma_tier_standard_option: "Estándar — USD 35 por huésped (antes USD 45)",
      bruma_tier_premium_option: "Premium — USD 50 por huésped (antes USD 60)",
      ...
      bruma_whatsapp_premium: "Premium (USD 50 lanzamiento · antes USD 60)",
      bruma_whatsapp_standard: "Estándar (USD 35 lanzamiento · antes USD 45)",
      bruma_order_tier_label: "Menú",
      bruma_order_tier_premium: "Premium · USD 50 (precio lanzamiento)",
      bruma_order_tier_standard: "Estándar · USD 35 (precio lanzamiento)",
    ...
    pt: {
      ...
      home_royal_meta_3: "Piscina",
      home_royal_meta_4: "Single USD 65 · Duplo USD 70 · Triplo USD 85",
      home_royal_desc:
        "Hotel em uma das principais avenidas de Colonia, a 200 metros do Bairro Histórico UNESCO e da praia. A 8 quarteirões dos terminais fluvial e terrestre. Café da manhã incluído, piscina e quartos single, duplo e triplo.",
      ...
      royal_about_p:
        "O Hotel Royal está localizado em uma das principais avenidas de Colonia del Sacramento, a apenas 200 metros do Bairro Histórico, Patrimônio da Humanidade desde 1995. A 200 metros da praia e a 8 quarteirões dos terminais fluvial e terrestre. Café da manhã incluído, piscina e quartos single, duplo e triplo — uma base ideal para explorar Colonia.",
      royal_steps_title: "Como reservar",
      royal_step_1_title: "Escolha suas datas:",
      royal_step_1_desc: "Selecione a data de check-in e o tipo de quarto abaixo.",
      royal_step_2_title: "Opções de quarto:",
      royal_step_2_desc: "Single, duplo ou triplo — informe quantos quartos você precisa.",
      royal_step_3_title: "Confirme no WhatsApp:",
      royal_step_3_desc: "Verificamos disponibilidade e confirmamos os detalhes da sua reserva.",
      royal_price_line: "Single USD 65 · Duplo USD 70 · Triplo USD 85",
      royal_price_title: "Por noite · Café da manhã incluído",
      royal_price_p:
        "Tarifas por quarto por noite. Use “Verificar disponibilidade” no WhatsApp para confirmar datas e tipo de quarto antes de reservar.",
      royal_rate_per_night: "Tarifa por noite",
      royal_estimated_total: "Total estimado",
      ...
      royal_rooms_title: "Tipos de quarto e tarifas",
      royal_room_single: "🛏 Quarto single · USD 65 por noite",
      royal_room_double: "🛏 Quarto duplo · USD 70 por noite",
      royal_room_triple: "🛏 Quarto triplo · USD 85 por noite",
      royal_room_single_short: "Single · USD 65",
      royal_room_double_short: "Duplo · USD 70",
      royal_room_triple_short: "Triplo · USD 85",
      ...
      royal_create_title: "Solicite sua estadia",
      royal_checkin_label: "Data de check-in",
      royal_checkin_hint: "Escolha a data de entrada para verificarmos a disponibilidade.",
      royal_room_type_label: "Tipo de quarto",
      royal_rooms_count_label: "Quantidade de quartos",
      royal_nights_label: "Noites",
      royal_reserve_btn: "Verificar disponibilidade",
      royal_wa_intro:
        "Olá! Gostaria de consultar disponibilidade no Hotel Royal para:",
      royal_wa_footer:
        "Poderiam confirmar se há disponibilidade para essas datas e me enviar a tarifa? Obrigado!",
      royal_date_tbd: "A confirmar",
      ...
      bruma_price_title: "Padrão USD 45 → USD 35 por hóspede · Premium USD 60 → USD 50",
      bruma_price_standard_label: "Padrão",
      bruma_price_standard_original: "USD 45",
      bruma_price_standard_discount: "USD 35 por hóspede",
      bruma_price_premium_label: "Premium",
      bruma_price_premium_original: "USD 60",
      ...
      bruma_tier_standard_option: "Padrão — USD 35 por hóspede (antes USD 45)",
      bruma_tier_premium_option: "Premium — USD 50 por hóspede (antes USD 60)",
      ...
      bruma_whatsapp_premium: "Premium (USD 50 lançamento · antes USD 60)",
      bruma_whatsapp_standard: "Padrão (USD 35 lançamento · antes USD 45)",
      bruma_order_tier_label: "Menu",
      bruma_order_tier_premium: "Premium · USD 50 (preço de lançamento)",
      bruma_order_tier_standard: "Padrão · USD 35 (preço de lançamento)",
