...
STRINGS = [
    ...
    ("home_hist_lieb_meta_1", "Historic Quarter walking tour • Vineyard & organic garden", "Caminata guiada en la ciudad vieja • Viñedo y huerta orgánica", "Caminhada guiada na cidade velha • Vinhedo e horta orgânica"),
    ...
    ("home_cabalgata_meta_2", "Horseback riding outside Colonia • Then Las Liebres vineyard & garden", "Cabalgata (fuera de Colonia) • Luego viñedo y huerta Las Liebres", "Cavalgada (fora de Colonia) • Depois vinhedo e horta Las Liebres"),
